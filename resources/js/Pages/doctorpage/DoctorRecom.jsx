        ...
        <div className="page-container">
            <div className="result-container">
                ...
                <div className="user-info">
                    ...
                    <p>
                        <strong>Height:</strong> {resultData.height} cm{" "}
                        {/* Tampilkan tinggi badan */}
                    </p>
                    <p>
                        <strong>Weight:</strong> {resultData.weight} kg{" "}
                        {/* Tampilkan berat badan */}
                    </p>
                    <p>
                        <strong>Smoke Status:</strong> {resultData.smokeStatus}{" "}
                        {/* Tampilkan status merokok */}
                    </p>
                    <p>
                        <strong>Active in Sport:</strong>{" "}
                        {resultData.sportStatus}{" "}
                        {/* Tampilkan status aktif berolahraga */}
                    </p>
                    <p>
                        <strong>Alcohol Status:</strong>{" "}
                        {resultData.alcoholStatus}{" "}
                        {/* Tampilkan status mengonsumsi alkohol */}
                    </p>
                    <p>
                        <strong>Check-up Period:</strong>{" "}
                        {resultData.checkupPeriod}
                    </p>
                </div>
                ...
                <div className="user-stats">
                    <div className="stat-item">
                        ...
                        <p
                            className={`stat-value ${resultData.cholesterolStatus}`}
                        >
                    ...
                    <div className="stat-item">
                        ...
                        <p className={`stat-value ${resultData.glucoseStatus}`}>
                            {resultData.glucoseStatus} (
                            {resultData.glucoseLevel} mg/dL)
                        </p>
                    </div>
                    ...
                    <div className="stat-item blood-pressure">
                        ...
                        <div className="blood-pressure-values">
                            <p>
                                <strong>SYS:</strong> {resultData.systolicBP}{" "}
                                mmHg
                            </p>
                            <p>
                                <strong>DIA:</strong> {resultData.diastolicBP}{" "}
                                mmHg
                            </p>
                            <p>
                ...
                <div className="button-container">
                    <Link className="back-button" href ="/doctor">
                        Back
                    </Link>
                    <button
