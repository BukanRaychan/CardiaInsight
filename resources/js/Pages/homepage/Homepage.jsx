...
//                 {/* {showForm1 && (
//                     <div className="pt-12">
//                         <Link className="animate-pulse w-60 h-60 text-custom-green text-[40px] shadow-lg font-bold font-sans rounded-full flex items-center justify-center border-4 border-custom-green">
//                             START
//                         </Link>
//                     </div>
//                 )} */}
